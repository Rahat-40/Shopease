  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        ...
        setProducts(Array.isArray(res.data) ? res.data.slice(0, 16) : []);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <Navbar role="BUYER"/>
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          <h1 className="text-3xl sm:text-4xl font-bold">Welcome To Buyer Deshboard</h1>
          <p className="mt-2 opacity-90">Browse products . Add to cart your Favourite products and place order.</p>
        </div>
      </div>
